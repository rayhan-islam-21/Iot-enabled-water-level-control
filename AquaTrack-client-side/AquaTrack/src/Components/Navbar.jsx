...
import { NavLink, useLocation, Link } from "react-router"; // ✅ fixed import
import { MdSpaceDashboard } from "react-icons/md";
import { TypeAnimation } from "react-type-animation";
import GridBackgroundView from "./MovingGrid";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <Button variant="outline" to="/auth/login">
              Login
            </Button>
          </div>
...
const Hero = () => (
  <section className="relative z-10 text-center py-16 sm:py-24 px-4">
    <div className="max-w-4xl mx-auto">
      <span className="inline-block px-4 py-1.5 text-xs font-semibold tracking-wider text-orange-600 dark:text-sky-400 uppercase bg-orange-100 dark:bg-sky-900/30 rounded-full">
        AquaTrack System
      </span>
      <h1 className="mt-6 text-3xl lg:text-7xl font-bold tracking-tight text-gray-900 dark:text-white leading-tight">
        Your Water System Can, <br />
      ...
      <p className="mt-6 max-w-2xl mx-auto md:text-lg text-gray-600 dark:text-gray-300">
        Control your pumps, monitor water levels, and get real-time temperature insights — all from
        your browser.
      </p>
      <div className="mt-10 flex flex-row items-center justify-center gap-2">
        <Button variant="outline" to="/dashboard">
          <span className="flex gap-1 items-center justify-center">
            <MdSpaceDashboard size={22} /> Go to Dashboard
          </span>
        </Button>
