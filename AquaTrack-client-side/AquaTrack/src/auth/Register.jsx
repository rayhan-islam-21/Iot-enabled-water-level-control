...
const LinkedInIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
const Register = () => {
  ...
  return <div className="flex items-center justify-center p-4 bg-sky-300 h-screen">
      <div className="w-full max-w-xl">
        {}
        <div className="signin-card bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm p-6">
          {}
